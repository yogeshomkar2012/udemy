...
//some() return boolean on function conditions
console.log(movements.some((e, i, a) => e >= 3000));
//output true
console.log(movements.some((e, i, a) => e >= 5000));
//output false
//every()
console.log(movements.every((mov) => mov > 0));
console.log(array1.every((mov) => mov > 0));
