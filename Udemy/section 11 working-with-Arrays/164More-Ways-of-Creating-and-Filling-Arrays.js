...
console.log(x);
const y = new Array(7);
console.log(y.fill(1));
const z = new Array(7).fill("z");
console.log(z);
console.log(new Array(10).fill(1, 3));
console.log(new Array(10).fill(1, 3, 5));
console.log(z.fill(2, 2, 6));
// array.from() this crates a new, shallow-copied array
// Array.from(object, mapFn, thisArg)
console.log(Array.from({ length: 10 }, () => 10));
console.log(Array.from({ length: 6 }, (cur, i) => `${i} : ${cur}`));
