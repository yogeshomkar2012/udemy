...
(Body Mass Index), which is calculated using the 
...
variables called massMark, heightMark, 
...
3.Log the value of BMIMark and 
BMIJohn to the console.

4.BONUS: Create a boolean variable markHigherBMI 
